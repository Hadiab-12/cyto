...
digraph finrisk_flowchart {
  ...
  # Main flow nodes
  A [label = 'FINRISK 2002 cohort n=13,437', fillcolor = none]
  B [label = 'Agreed to participate n=8,799', fillcolor = none]
  C [label = 'Donated fecal sample n=7,054', fillcolor = none]
  D [label = 'Participants with cytokines data n=2,501', fillcolor = none]
  E [label = 'Participants with no missing data on covariates n=2,484', fillcolor = none]
  F [label = 'Participants with > 50,000 reads n=2,481', fillcolor = none]
  G [label = 'Final study sample n=2,398', fillcolor = none]

  # Exclusion nodes
  E0 [label = 'Did not agree to participate n=4,638', fillcolor = none]
  E1 [label = 'Did not donate fecal sample n=1,745', fillcolor = none]
  E2 [label = 'No cytokines data n=4,553', fillcolor = none]
  E3 [label = 'Missing covariate data n=17', fillcolor = none]
  E4 [label = '<50,000 reads n=3', fillcolor = none]
  E5 [label = 'Recent antibiotic use n=83', fillcolor = none]
...
rsvg_png(charToRaw(svg), file = "C:/Users/hadiab/Documents/cytokines/Figure1_cyto.png", width = 2000, height = 1000)
